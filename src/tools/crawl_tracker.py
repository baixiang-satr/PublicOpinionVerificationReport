...
_FAILURE_ADVICE: dict[str, str] = {
    ...
    "AUTHOR_IDENTITY_UNVERIFIED": "主页缺少可核验的头部昵称或账号 ID，无法确认身份，按无截图处理。",
    "AUTHOR_PAGE_TYPE_INVALID": "候选页面不是个人/媒体/店铺主页（如企业栏目或文章页），已拒绝截图。",
    "AUTHOR_OVERLAY_BLOCKED": "主页弹窗或登录组件遮挡主体区域，按无截图处理。",
    "AUTHOR_DECISION_MISSING": "主页截图缺少验收判定记录，已在 ZIP 前审计中移除。",
    "AUTHOR_CONTENT_NOT_READY": "作者主页没有渲染出可核验的身份信息或实质内容。",
    "AUTHOR_HTTP_ERROR": "作者主页返回 HTTP 错误，不生成主页附件。",
    "AUTHOR_URL_INVALID": "作者主页候选 URL 无效，未生成主页附件。",
    "AUTHOR_TIMEOUT": "作者主页访问超时，未生成主页附件。",
    "AUTHOR_NAVIGATION_FAILED": "作者主页访问失败，未生成主页附件。",
    # OCR
